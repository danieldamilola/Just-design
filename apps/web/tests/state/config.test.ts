...
describe('loadConfig', () => {
  ...
  it('preserves a valid saved accent color and an explicitly saved dark theme', () => {
    const savedConfig: Partial<AppConfig> = {
      theme: 'dark',
      accentColor: '#4F46E5',
    };
    ...
    // The theme system is active, so a stored dark preference is honored on
    // read (see tests/state/theme-resolution). The accent must survive too.

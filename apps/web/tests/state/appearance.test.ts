...
describe('applyAppearanceToDocument', () => {
  ...
  it('applies the system theme (no data-theme) and accent variables to the root element', () => {
  ...
  it('applies accent variables while leaving a stale dark data-theme to the system theme', () => {

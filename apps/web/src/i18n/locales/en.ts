...
export const en: Dict = {
  ...
  "home.starter.product_ui_prototype.desc": 'Based on your goal, begin with a clickable interface you can refine.',
  "home.starter.product_ui_prototype.firstPrompt": 'Design an editable product prototype for [your product] with the key screens and a clear primary flow.',
  "home.starter.product_ui_component.title": 'Start from a reusable component',
  "home.starter.product_ui_component.desc": 'Build one component first, then compose it into full screens.',
  "home.starter.product_ui_component.firstPrompt": 'Design a reusable [component name] component with its main states and variants.',
  "home.starter.product_ui_lowfi.title": 'Start with a low-fidelity prototype',
  "home.starter.product_ui_lowfi.desc": 'Sketch the structure first, then raise the fidelity.',
  "home.starter.product_ui_lowfi.firstPrompt": 'Create a low-fidelity wireframe of the main screens for [your product].',
  ...
  "home.starter.marketing_landing.firstPrompt": 'Design a landing page for [your product] with a hero, key benefits, and a clear call to action.',
  "home.starter.marketing_multivariant.title": 'Start with multiple landing variants',
  "home.starter.marketing_multivariant.desc": 'Generate a few versions to compare before you commit.',
  "home.starter.marketing_multivariant.firstPrompt": 'Create 3 landing page variants for [your product] with different hero messaging to compare.',
  ...
  "home.starter.internal_dashboard.firstPrompt": 'Design an internal dashboard showing [key metrics] with filters and a data table.',
  ...
  "home.starter.internal_report.firstPrompt": 'Create a report page summarizing [describe the data, fields, and metrics you care about].',
  "home.starter.general_menu.title": 'Start with your first project',
  "home.starter.general_menu.desc": "Describe what you want and we'll generate an editable first version.",
  "home.starter.general_menu.firstPrompt": 'Create an editable first version of [describe what you want to make].',
  ...
  "settings.memoryProfileHint": 'A few facts about you and your defaults. Memory injects this before every task so the agent infers what you mean from a short ask.',
  "settings.memoryProfileName": 'Work profile',
  "settings.memoryProfileDescription": 'Role, company, domain, audience, taste, and defaults the assistant should reuse.',
  ...
  "settings.memoryProfileAestheticPlaceholder": 'e.g. clean and editorial, light backgrounds, generous whitespace',
  ...
  "settings.memoryProfileGoalsPlaceholder": 'e.g. ship the new pricing page, raise conversion on the trial flow',
  "settings.memoryHooksTitle": 'Memory hooks',
  "settings.memoryHooksHint": 'Choose which parts of memory run automatically. The master switch above turns all of them off.',
